						...
						<div class="form-group">
							...
							<div class="col-md-3 date">
								<div class="input-group input-append date" id="committeeFormYear">
									<input id="committeeYear" name="committeeYear" type="text" class="form-control datepicker" placeholder="Year of membership" value="<?php echo htmlspecialchars($memberSinceYear); ?>"/>
